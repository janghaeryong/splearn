...
class MemberApiWebMvcTest {
    ...
    void register() throws JsonProcessingException {
        ...
        assertThat(mockMvcTester.post().uri("/api/members").contentType(MediaType.APPLICATION_JSON)
                .content(requestJson))
                .hasStatusOk()
                .bodyJson()
    ...
    void registerFail() throws JsonProcessingException {
        MemberRegisterRequest request = MemberFixture.createMemberRegisterRequest("invaild email");
        String requestJson = objectMapper.writeValueAsString(request);
